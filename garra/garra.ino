...
const int PIN_SERVO = 8; // Pino de comandos para o servo motor
const int VRY = A4; // Pino para leitura do eixo X
const int VRX = A5; // Pino para leitura do eixo Y

const int CLOSE = 165; // Limite de fechamento do servo
const int OPEN = 80; // Limite de abertura do servo
...
int posi_atual = 504; // Variável de referência
